...
def create_plot():
    ...
    # 스프링부트에 img경로 맞추기 ★
    plt.savefig('d:/kdt/FinalProject/git_final/final_project/src/main/resources/static/img/pie.png')
    plt.clf()  # 이전 차트를 초기화
    ...
    # 스프링부트에 img경로 맞추기 ★
    plt.savefig('d:/kdt/FinalProject/git_final/final_project/src/main/resources/static/img/bar.png')
    plt.clf()  # 이전 차트를 초기화
